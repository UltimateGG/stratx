 ...
 * @see KeyedOHLCSeries
 */
public class KeyedOHLCSeriesCollection extends AbstractXYDataset
        implements KeyedOHLCDataset, Serializable {
     ...
     */
    public KeyedOHLCSeriesCollection() {
    ...
    public int getID(int series, int item) {
        KeyedOHLCSeries s = (KeyedOHLCSeries) this.data.get(series);
        KeyedOHLCItem di = (KeyedOHLCItem) s.getDataItem(item);
        return di.getID();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof KeyedOHLCSeriesCollection)) {
            return false;
        }
        KeyedOHLCSeriesCollection that = (KeyedOHLCSeriesCollection) obj;
    ...
    public Object clone() throws CloneNotSupportedException {
        KeyedOHLCSeriesCollection clone
                = (KeyedOHLCSeriesCollection) super.clone();
